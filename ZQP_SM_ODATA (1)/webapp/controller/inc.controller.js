sap.ui.define([
	...
	return Controller.extend("SANGAVI_EHSMSANGAVI_EHSM.controller.inc", {
		onLogin : function(){
		...
		onInit: function(){
			...
			oe.read("/ZQP_INSPECTION_SMSet?$filter=ImPlant eq '1001'&$format=json",{
				context:null,
				urlParameter:null,
				async:false,
		 ...
		 * @memberOf SANGAVI_EHSMSANGAVI_EHSM.view.inc
		 */
		//	onInit: function() {
		//
		//	},
